...
%% This function Ideally does normalized cut on the projected pairwise 
% affinity matrix. 
N = size(A,1);
...
%     [cntrs, indicesKmeans] = kmeans(U', K, 'Initialization', 'plusplus');
%     This is  f you use 'vlfeat' 
%     indicesKmeans = indicesKmeans'; 
